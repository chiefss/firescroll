class Constant {
    static get SPEED_VALUE() { return 1 };
    static get SPEED_SLOW_VALUE() { return 1 };
    static get SPEED_NORMAL_VALUE() { return 2 };
    static get SPEED_FAST_VALUE() { return 3 };
    static get APPEND_TO_ELEMENT_CSS_SELECTOR() { return 'body' };
